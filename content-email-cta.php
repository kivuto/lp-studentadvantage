  ...
  <div id="lets-talk" class="row mainContent content-new-email headline-cta" data-block="<?php echo $block5; ?>">
      <div class="container">
          <div class="row">
          ...
          <div class="row">
                 <link href="//cdn-images.mailchimp.com/embedcode/classic-10_7.css" rel="stylesheet" type="text/css">
                  <div id="mc_embed_signup">
                     <form action="send-email.php" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate">
                        <div id="mc_embed_signup_scroll">
                           ...
                           <div class="mc-field-group size1of2">
                              <label for="mce-PHONE">Phone <span class="asterisk-hidden">*</span> </label>
                              <input type="text" name="PHONE" class="" value="" id="mce-PHONE">
                           </div>
                           <p class="hidden-break">&nbsp;</p>
                           <div class="mc-field-group">
                              <label for="mce-INST">Institution  <span class="asterisk">*</span>
                              </label>
                              <input type="text" value="" name="INST" class="required institution" id="mce-INST" required>
                           </div>
                           <div class="mc-field-group size1of2">
                              <label for="mce-NUMBER">Agreement Number  <span class="asterisk">*</span>
                              </label>
                              <input type="text" name="NUMBER" class="required" value="" id="mce-NUMBER" required>
                           </div>
                           <div class="mc-field-group size1of2">
                              <label for="mce-WEBSITE">Website <span class="asterisk-hidden">*</span> </label>
                              <input type="text" value="" name="WEBSITE" class=" url" id="mce-WEBSITE">
                           </div>
                           <p class="hidden-break">&nbsp;</p>
                           <div class="mc-field-group size1of2">
                           ...
                           <div class="mc-field-group size1of2">
                              <label for="mce-LANGUAGE">Preferred Language  <span class="asterisk">*</span>
                              </label>
                              <select name="LANGUAGE" class="required" id="mce-LANGUAGE" required>
                                 <option value=""></option>
                                 ...
                                 <option value="Nederlands (België)">Nederlands (België)</option>
                                 <option value="Nederlands (Nederland)">Nederlands (Nederland)</option>
                                 <option value="Português (Brasil)">Português (Brasil)</option>
                                 <option value="Svenska (Sverige)">Svenska (Sverige)</option>
                                 <option value="Türkçe">Türkçe</option>
                                 <option value="Русский">Русский</option>
                                 <option value="中文 (台灣)">中文 (台灣)</option>
                                 <option value="中文 (简体，中国)">中文 (简体，中国)</option>
                                 <option value="한국어">한국어</option>
                                 <option value="日本語">日本語</option>
                              </select>
                           </div>
                           <div class="mc-field-group size1of2">
                              <label for="mce-REGION">Please Select Your Region of Operation  <span class="asterisk">*</span>
                              </label>
                           ...
                           <div class="mc-field-group size1of2">
                              <label for="mce-PREFERTIME">Preferred Contact Time  <span class="asterisk">*</span>
                              </label>
                              <select name="PREFERTIME" class="required" id="mce-PREFERTIME" required>
                                 <option value=""></option>
                           ...
                           <div class="mc-field-group" style="display:none;">
                              <input type="text" value="Office 365 ProPlus" name="PROGRAM" class="" id="mce-PROGRAM">
                              <input type="text" value="english" name="FORMLANG" class="" id="mce-FORMLANG">
                           </div>
                           <div class="mc-field-group input-group" style="display:none;">
                              <ul>
                                 <li><input type="checkbox" value="Yes" name="OPTIN" id="mce-group[1]-1-0"><label for="mce-group[1]-1-0" class="checkbox-label"> &nbsp;{{opt_in}}</label></li>
                              </ul>
                           </div>
                           ...
                           <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_56207817284eac40f14c245a7_45477bc4ed" tabindex="-1" value=""></div>
                           <p class="hidden-break">&nbsp;</p>
                           <div class="clear"><br/><input type="submit" value="Submit" name="subscribe" id="mc-embedded-subscribe" on class="button orange"></div>
                        </div>
                     </form>
                  </div>
