  <div id="<?php echo $block1; ?>" class="row mainContent content-introduction content-overlay-video" data-block="<?php echo $block1; ?>">
      ...
      <div class="ovrlay">
          <div class="container">
              ...
              <div class="row">
                  ...
                  <li>
                      <a class="savideo ctaBtn" href="//player.vimeo.com/video/91340823&autoplay=1" onclick="tib('', 'Student Advantage LP', 'Student Advantage LP - Clickthrough', 'Student Advantage LP - Clickthrough - Introduction - Watch video'); return false;">
